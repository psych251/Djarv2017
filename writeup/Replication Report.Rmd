...
Djärv et al. (2017) shows the difference in the entailment of the presupposed content between cognitive and emotive factives. Specifically, cognitive factives, such as *realize* and *be aware*, entail both the presupposed content in the embedded clause and the attitude/behavior indicated by the predicate. On the other hand, emotive factives, such as *appreciate* and *be happy*, only entail the attitude/behavior. 

### Stimuli and Procedure

The participants were presented a pair of question and answer. The answer either provides an affirmation and then denies the content of the embedded content (*yes, although...* continuation as illustrated in Yes-response block) or directly provides a negative response (*no, because...* continuation as illustrated in No-response block).
