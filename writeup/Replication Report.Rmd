...
# checkign the number of each item
...
# exclude random effect of item for now: not enough observations for each item
simple_model = lmer(rating ~ predicate_type * answer_type + (predicate_type * answer_type  | participant),
             data = df.data.clean |>
               filter(stimulus_type == "C"))
